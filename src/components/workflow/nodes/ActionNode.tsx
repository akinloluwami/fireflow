...
import { Trash2, Copy, Cog, AlertTriangle } from "lucide-react";
...
function ActionNodeComponent({ id, data, selected }: ActionNodeProps) {
  ...
  return (
    <div
      ...
      `}
      style={{ borderTopWidth: "2px", borderTopColor: "#3b82f6" }}
      onClick={() => selectNode(id)}
    >
      {/* Badge */}
      <div className="absolute -top-2 left-2.5 px-1.5 py-0.5 bg-blue-500 rounded flex items-center gap-0.5">
        <Cog size={8} className="text-white" />
      ...
      {/* Config preview */}
      <div className="mx-2 mb-2 px-2 py-1 bg-blue-50 rounded border border-blue-100">
